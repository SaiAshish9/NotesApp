...
$message .= "https://notesappbysai.000webhostapp.com/activate.php?email=" . urlencode($email) . "&key=$activationKey";
if(mail($email, 'Confirm your Registration', $message, 'From:'.'saiashish7777@gmail.com')){
